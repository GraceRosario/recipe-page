...
I learned that instead of wrapping <li> on <span> or other tags like that to create space between bullet and it's content, it is better to do that by giving padding left to <li>
